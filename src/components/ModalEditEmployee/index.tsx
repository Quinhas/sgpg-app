...
export function ModalEditEmployee({
  ...
  const initialValues: FormFields = {
    ...
    addr: employee.employee_addr ?? "",
    email: employee.employee_email ?? "",
    isDeleted: employee.is_deleted ? "yes" : "no",
    phone: employee.employee_phone ?? "",
    role: employee.employee_role ?? -1,
    salary: employee.employee_salary ?? 0,
    password: "",
    confirmPassword: "",
  };
            ...
            <Formik
              ...
              onSubmit={async (values) => {
                ...
                try {
                  ...
                  await api.updateEmployee(employee.employee_id, _employee);
                  toast({
                    title: "Eba!",
